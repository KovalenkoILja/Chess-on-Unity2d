...
namespace MaterialUI
{
    public class MaterialBaseEditor : Editor
    {
        ...
        {
            if (m_ShowComponentsAnimBool != null) m_ShowComponentsAnimBool.valueChanged.RemoveListener(Repaint);
            if (m_ShowColorsAnimBool != null) m_ShowColorsAnimBool.valueChanged.RemoveListener(Repaint);
            if (m_ShowExternalPropertiesAnimBool != null)
                m_ShowExternalPropertiesAnimBool.valueChanged.RemoveListener(Repaint);
            if (m_ShowCustom1AnimBool != null) m_ShowCustom1AnimBool.valueChanged.RemoveListener(Repaint);
            if (m_ShowCustom2AnimBool != null) m_ShowCustom2AnimBool.valueChanged.RemoveListener(Repaint);
        }
        ...
        protected void DrawFoldoutColors(Action drawSection)
        {
            ...
            if (EditorGUI.EndChangeCheck()) EditorPrefs.SetBool(m_ColorsPrefKey, m_ShowColors);

            m_ShowColorsAnimBool.target = m_ShowColors;

            if (EditorGUILayout.BeginFadeGroup(m_ShowColorsAnimBool.faded)) drawSection();
        ...
        protected void DrawFoldoutComponents(Action drawSection)
        {
            ...
            if (EditorGUI.EndChangeCheck()) EditorPrefs.SetBool(m_ComponentsPrefKey, m_ShowComponents);

            m_ShowComponentsAnimBool.target = m_ShowComponents;

            if (EditorGUILayout.BeginFadeGroup(m_ShowComponentsAnimBool.faded)) drawSection();
            EditorGUILayout.EndFadeGroup();
        }
        ...
        protected void DrawFoldoutExternalProperties(Func<bool> drawSection)
        {
            ...
            if (EditorGUI.EndChangeCheck()) EditorPrefs.SetBool(m_ExternalPropertiesPrefKey, m_ShowExternalProperties);
        ...
        protected void DrawFoldoutCustom1(string label, Func<bool> drawSection)
        {
            ...
            if (EditorGUI.EndChangeCheck()) EditorPrefs.SetBool(m_Custom1PrefKey, m_ShowCustom1);
        ...
        protected void DrawFoldoutCustom2(string label, Func<bool> drawSection)
        {
            ...
            if (EditorGUI.EndChangeCheck()) EditorPrefs.SetBool(m_Custom2PrefKey, m_ShowCustom2);
        ...
        {
            public TargetArray(Object[] targets)
            {
                targetArray = targets.Cast<T>().ToArray();
            }

            public T[] targetArray { get; set; }

            public void ExecuteAction(Action<T> executeAction)
            {
                for (var i = 0; i < targetArray.Length; i++) executeAction(targetArray[i]);
            }
        }
    }
}
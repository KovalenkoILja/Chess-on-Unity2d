...
namespace MaterialUI
{
    ...
    public class ScreenViewEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (!m_AutoTrackScreens.boolValue) EditorGUILayout.PropertyField(m_MaterialScreens, true);
            ...
            {
                var names = new string[materialScreen.Length];

                for (var i = 0; i < materialScreen.Length; i++) names[i] = i + 1 + " - " + materialScreen[i].name;
            ...
            var controllingAnyScreenConfigs = false;
            for (var i = 0; i < m_ScreenView.materialScreen.Length; i++)
            {
                var t = m_ScreenView.materialScreen[i];
            ...
            {
                var fadeIn = m_FadeIn.boolValue;
                var scaleIn = m_ScaleIn.boolValue;
                var slideIn = m_SlideIn.boolValue;
                var rippleIn = m_RippleIn.boolValue;
                var fadeOut = m_FadeOut.boolValue;
                var scaleOut = m_ScaleOut.boolValue;
                var slideOut = m_SlideOut.boolValue;
                var rippleOut = m_RippleOut.boolValue;

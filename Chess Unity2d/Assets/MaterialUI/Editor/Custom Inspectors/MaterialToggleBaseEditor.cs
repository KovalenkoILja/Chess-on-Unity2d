...
namespace MaterialUI
{
    public class MaterialToggleBaseEditor : MaterialBaseEditor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (EditorGUI.EndChangeCheck()) m_Toggle.interactable = m_Interactable.boolValue;

            if (m_Graphic.objectReferenceValue != null)
            {
                EditorGUILayout.PropertyField(m_GraphicChangesWithToggleState);

                if (m_Graphic.objectReferenceValue.GetType() == typeof(Image) ||
                    m_Graphic.objectReferenceValue.GetType() == typeof(VectorImage))
                {
            ...
            EditorGUI.BeginDisabledGroup(m_IsControllingChildren);
            {
                ...
                if (EditorGUI.EndChangeCheck()) m_Toggle.EditorValidate();
            }

...
namespace MaterialUI
{
    public class VectorImageParserJustVector : VectorImageFontParser
    {
        ...
        {
            return
                "https://github.com/Seich/JustVector-Icons-Font/blob/master/justVector%20Font/fonts/JustVector_befc36341d9795c51945d4d132517a7a.ttf?raw=true";
        }
        ...
        {
            return
                "https://github.com/Seich/JustVector-Icons-Font/blob/master/justVector%20Font/stylesheets/justVector.css?raw=true";
        }
        ...
        protected override VectorImageSet GenerateIconSet(string fontDataContent)
        {
            ...
            foreach (var line in fontDataContent.Split(new[] {"\n"}, StringSplitOptions.RemoveEmptyEntries))
                ...
                {
                    var name = line.Replace(".jv-", string.Empty).Trim();

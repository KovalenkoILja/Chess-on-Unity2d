...
namespace MaterialUI
{
    ...
    public class VectorImageFileParserFontello : VectorImageFontParser
    {
        ...
        {
            var fonts = Directory.GetFiles(m_UnzipPath + "/font", "*.ttf");
        ...
        private void UnzipFile()
        {
            ...
            {
                var info = new DirectoryInfo(m_ZipPath);
        ...
        public static VectorImageSet GenerateSpecificIconSet(string fontDataContent)
        {
            ...
            foreach (var line in fontDataContent.Split(new[] {"\n"}, StringSplitOptions.RemoveEmptyEntries))
            {
                ...
                if (line.StartsWith("      \"code\":"))
                    ...
                    {
                        var stringcode = line.Substring(line.IndexOf(":") + 2).Replace(",", "").Replace("\"", "")
                            .Trim();
                        var intcode = int.Parse(stringcode);

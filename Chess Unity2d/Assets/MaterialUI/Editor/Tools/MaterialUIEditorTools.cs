...
namespace MaterialUI
{
    ...
    public static class MaterialUIEditorTools
    {
        ...
        {
            m_LastInstance =
                Object.Instantiate(AssetDatabase.LoadAssetAtPath("Assets/MaterialUI/Prefabs/" + assetPath + ".prefab",
            ...
            {
                var savedLastInstance = m_LastInstance;

                var instantiationHelper = m_LastInstance.GetComponent<InstantiationHelper>();
                ...
                if (savedLastInstance != null) Selection.activeObject = savedLastInstance;
            }
        ...
        private static void CreateCanvasIfNeeded()
        {
            ...
            if (m_NotCanvas)
            {
                if (!Object.FindObjectOfType<EventSystem>())
                    Object.Instantiate(
                        AssetDatabase.LoadAssetAtPath("Assets/MaterialUI/Prefabs/Common/EventSystem.prefab",
                ...
                if (!m_SelectedObject)
                {
                    m_SelectedObject =
                        Object.Instantiate(
                            AssetDatabase.LoadAssetAtPath("Assets/MaterialUI/Prefabs/Common/Canvas.prefab",
                                typeof(GameObject))) as GameObject;
        ...
        {
            CreateInstance("Components/Empty Object", "Empty Object",
                EmptyUIObjectInstantiationHelper.optionHasLayoutHorizontal);
        }
        ...
        {
            CreateInstance("Components/Empty Object", "Empty Object",
                EmptyUIObjectInstantiationHelper.optionHasLayoutVertical);
        }
        ...
        {
            CreateInstance("Components/Empty Object", "Empty Object", EmptyUIObjectInstantiationHelper.optionFitted,
                EmptyUIObjectInstantiationHelper.optionHasLayoutHorizontal);
        }
        ...
        {
            CreateInstance("Components/Panel", "Panel", PanelInstantiationHelper.optionStretched,
                PanelInstantiationHelper.optionHasLayoutHorizontal);
        }
        ...
        {
            CreateInstance("Components/Panel", "Panel", PanelInstantiationHelper.optionStretched,
                PanelInstantiationHelper.optionHasLayoutVertical);
        }
        ...
        {
            CreateInstance("Components/Panel", "Panel", PanelInstantiationHelper.optionFitted,
                PanelInstantiationHelper.optionHasLayoutHorizontal);
        }
        ...
        {
            CreateInstance("Components/Buttons/Button", "Button - Flat",
                ButtonRectInstantiationHelper.optionHasContent);
        }

        [MenuItem("GameObject/MaterialUI/Buttons/Multi Content/Raised", false, 030)]
        private static void CreateButtonMultiRaised()
        {
            CreateInstance("Components/Buttons/Button", "Button - Raised",
                ButtonRectInstantiationHelper.optionHasContent, ButtonRectInstantiationHelper.optionRaised);
        }
        ...
        {
            CreateInstance("Components/Buttons/Floating Action Button", "Floating Action Button - Raised",
                ButtonRoundInstantiationHelper.optionRaised);
        }
        ...
        {
            CreateInstance("Components/Buttons/Floating Action Button", "Floating Action Button Mini - Raised",
                ButtonRoundInstantiationHelper.optionMini, ButtonRoundInstantiationHelper.optionRaised);
        }

        [MenuItem("GameObject/MaterialUI/Buttons/Icon Button/Normal", false, 030)]
        private static void CreateIconButton()
        {
            CreateInstance("Components/Buttons/Floating Action Button", "Icon Button - Flat",
                InstantiationHelper.optionNone);
        }

        [MenuItem("GameObject/MaterialUI/Buttons/Icon Button/Mini", false, 030)]
        private static void CreateMiniIconButton()
        {
            CreateInstance("Components/Buttons/Floating Action Button", "Icon Button Mini - Flat",
                ButtonRoundInstantiationHelper.optionMini);
        }

        [MenuItem("GameObject/MaterialUI/Dropdowns/Flat", false, 030)]
        private static void CreateDropdownFlat()
        {
            CreateInstance("Components/Buttons/Button", "Dropdown - Flat",
                ButtonRectInstantiationHelper.optionHasDropdown, ButtonRectInstantiationHelper.optionHasContent);
        }

        [MenuItem("GameObject/MaterialUI/Dropdowns/Raised", false, 030)]
        private static void CreateDropdownRaised()
        {
            CreateInstance("Components/Buttons/Button", "Dropdown - Raised",
                ButtonRectInstantiationHelper.optionHasDropdown, ButtonRectInstantiationHelper.optionHasContent,
                ButtonRectInstantiationHelper.optionRaised);
        }

        [MenuItem("GameObject/MaterialUI/Dropdowns/Icon Button", false, 030)]
        private static void CreateIconDropdown()
        {
            CreateInstance("Components/Buttons/Floating Action Button", "Dropdown Icon Button",
                ButtonRoundInstantiationHelper.optionHasDropdown);
        }

        [MenuItem("GameObject/MaterialUI/Dropdowns/Mini Icon Button", false, 030)]
        private static void CreateMiniIconDropdown()
        {
            CreateInstance("Components/Buttons/Floating Action Button", "Dropdown Mini Icon Button",
                ButtonRoundInstantiationHelper.optionHasDropdown, ButtonRoundInstantiationHelper.optionMini);
        }
        ...
        {
            CreateInstance("Components/Input Field", "Input Field", InputFieldInstantiationHelper.optionHasIcon,
                InputFieldInstantiationHelper.optionHasClearButton);
        }
        ...
        {
            CreateInstance("Components/Slider", "Slider - Left Label",
                MaterialSliderInstantiationHelper.optionHasLabel);
        }
        ...
        {
            CreateInstance("Components/Slider", "Slider - Left and Right labels",
                MaterialSliderInstantiationHelper.optionHasLabel, MaterialSliderInstantiationHelper.optionHasTextField);
        }
        ...
        {
            CreateInstance("Components/Slider", "Slider - Left label and Right inputField",
                MaterialSliderInstantiationHelper.optionHasLabel,
                MaterialSliderInstantiationHelper.optionHasInputField);
        }
        ...
        {
            CreateInstance("Components/Slider", "Slider - Left icon and Right inputField",
                MaterialSliderInstantiationHelper.optionHasIcon, MaterialSliderInstantiationHelper.optionHasInputField);
        }
        ...
        {
            CreateInstance("Components/Slider", "Slider - Left Label", MaterialSliderInstantiationHelper.optionDiscrete,
                MaterialSliderInstantiationHelper.optionHasLabel);
        }
        ...
        {
            CreateInstance("Components/Slider", "Slider - Left icon", MaterialSliderInstantiationHelper.optionDiscrete,
                MaterialSliderInstantiationHelper.optionHasIcon);
        }
        ...
        {
            CreateInstance("Components/Slider", "Slider - Left and Right labels",
                MaterialSliderInstantiationHelper.optionDiscrete, MaterialSliderInstantiationHelper.optionHasLabel,
                MaterialSliderInstantiationHelper.optionHasTextField);
        }
        ...
        {
            CreateInstance("Components/Slider", "Slider - Left icon and Right inputField",
                MaterialSliderInstantiationHelper.optionDiscrete, MaterialSliderInstantiationHelper.optionHasIcon,
                MaterialSliderInstantiationHelper.optionHasInputField);
        }
        ...
        {
            CreateInstance("Resources/Progress Indicators/Circle Progress Indicator",
                "Circle Progress Indicator - Flat", InstantiationHelper.optionNone);
        }
        ...
        {
            CreateInstance("Resources/Progress Indicators/Circle Progress Indicator",
                "Circle Progress Indicator - Raised", CircleProgressIndicatorInstantiationHelper.optionRaised);
        }
        ...
        {
            CreateInstance("Resources/Progress Indicators/Circle Progress Indicator",
                "Circle Progress Indicator - Flat", CircleProgressIndicatorInstantiationHelper.optionHasLabel,
                CircleProgressIndicatorInstantiationHelper.optionLayoutHorizontal);
        }
        ...
        private static void CreateProgressLabelCircleRaisedHorizontal()
        {
            CreateInstance("Resources/Progress Indicators/Circle Progress Indicator",
                "Circle Progress Indicator - Raised", CircleProgressIndicatorInstantiationHelper.optionRaised,
                CircleProgressIndicatorInstantiationHelper.optionHasLabel,
                CircleProgressIndicatorInstantiationHelper.optionLayoutHorizontal);
        }
        ...
        private static void CreateProgressLabelCircleFlatVertical()
        {
            CreateInstance("Resources/Progress Indicators/Circle Progress Indicator",
                "Circle Progress Indicator - Flat", CircleProgressIndicatorInstantiationHelper.optionHasLabel,
                CircleProgressIndicatorInstantiationHelper.optionLayoutVertical);
        }
        ...
        {
            CreateInstance("Resources/Progress Indicators/Circle Progress Indicator",
                "Circle Progress Indicator - Flat", CircleProgressIndicatorInstantiationHelper.optionRaised,
                CircleProgressIndicatorInstantiationHelper.optionHasLabel,
                CircleProgressIndicatorInstantiationHelper.optionLayoutVertical);
        }
        ...
        {
            CreateInstance("Components/Divider", "Divider - Vertical Light", DividerInstantiationHelper.optionLight,
                DividerInstantiationHelper.optionVertical);
        }
        ...
        private static void CreateNavDrawer()
        {
            ...
            m_LastInstance.GetComponent<RectTransform>().sizeDelta =
                new Vector2(m_LastInstance.GetComponent<RectTransform>().sizeDelta.x, 8f);
        ...
        {
            CreateInstance("Components/TabView", "Tab View", TabViewInstantiationHelper.optionHasIcon,
                TabViewInstantiationHelper.optionHasLabel);
        }
        ...
        {
            var sourceGameObject = Selection.activeGameObject;
            Undo.RecordObject(sourceGameObject, sourceGameObject.name);
            var sourceRectTransform = sourceGameObject.GetComponent<RectTransform>();
            var sourcePos = sourceRectTransform.position;
            var sourceSize = sourceRectTransform.sizeDelta;
            var sourceLayoutSize = sourceRectTransform.GetProperSize();
            var sourceImage = sourceGameObject.GetAddComponent<Image>();

            CreateShadow();

            var shadowGameObject = Selection.activeGameObject;
            shadowGameObject.name = sourceGameObject.name + " Shadow";
            var shadowGenerator = shadowGameObject.GetAddComponent<ShadowGenerator>();
            shadowGenerator.sourceImage = sourceImage;

            var shadowTransform = shadowGameObject.GetAddComponent<RectTransform>();
            ...
            var probablyHasLayout = sourceGameObject.GetComponent<LayoutGroup>() != null ||
                                    sourceGameObject.GetComponent<LayoutElement>() != null;

            var newParentGameObject = new GameObject(sourceGameObject.name);
            newParentGameObject.transform.SetParent(sourceRectTransform.parent);
            var newParentRectTransform = newParentGameObject.GetAddComponent<RectTransform>();

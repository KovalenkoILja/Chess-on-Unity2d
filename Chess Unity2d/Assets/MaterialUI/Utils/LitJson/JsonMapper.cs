    ...
    public class JsonMapper
    {
        ...
        private static object ReadValue(Type inst_type, JsonReader reader)
        {
                ...
                reader.Token == JsonToken.Float)
            {
                ...
                if (json_type.Name.Equals("Int32") && inst_type.Name.Equals("Int64")) return reader.Value;
                ...
                while (true)
                {
                    ...
                    if (t_data.Properties.ContainsKey(property))
                    {
                        ...
                        else
                        {
                            ...
                            if (p_info.CanWrite)
                                p_info.GetSetMethod().Invoke(instance, new[] {ReadValue(prop_data.Type, reader)});
        ...
        private static void RegisterBaseExporters()
        {
            ...
            base_exporters_table[typeof(long)] =
                delegate(object obj, JsonWriter writer) { writer.Write((long) obj); };
        }
        ...
        private static void RegisterBaseImporters()
        {
            ...
            importer = delegate(object input) { return Convert.ToSingle((float) input); };

...
namespace U3D
{
    ...
    {
        private readonly List<Exception> m_innerExceptions; // Complete set of exceptions.

        public AggregateException(params Exception[] es) : base(
            "Target invocation caused an exception, check InnerExceptions")
        {
            m_innerExceptions = new List<Exception>(es);
        }

        /// <summary>
        ///     Invokes a handler on each <see cref="T:System.Exception" /> contained by this
        ///     <see
        ...
        ///     An exception contained by this
        ///     <see
        ///         cref="AggregateException" />
        ///     was not handled.
        /// </exception>
        /// <exception cref="T:System.ArgumentNullException">
        ///     The <paramref name="predicate" /> argument is
        ///     null.
        /// </exception>
        public ReadOnlyCollection<Exception> InnerExceptions => new ReadOnlyCollection<Exception>(m_innerExceptions);

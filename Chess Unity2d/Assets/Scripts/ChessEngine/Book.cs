...
namespace ChessEngine
{
    public static class Book
    {
        ...
        //Size: 1537
        private static List<OpeningMove> PopulateOpeningBook()
        {
        ...
        internal static int ValidateOpeningBook(IEnumerable<OpeningMove> openingBook)
        {
            return (from moves in openingBook
                from move in moves.Moves
                where !IsValidMove(move.MovingPiecePrimary.SrcPosition,
                    move.MovingPiecePrimary.DstPosition,
                    moves.StartingFEN)
                select moves).Count();
        }
        ...
        private static bool IsValidMove(byte srcPos, byte dstPos, string fen)
        {
            ...
            return dstPos == chessBoard.EnPassantPosition;
        }
    }
}
    ...
    internal sealed class Piece
    {
        ...
        internal static string GetPieceTypeShort(ChessPieceType pieceType)
        {
            switch (pieceType)
            {
                ...
                case ChessPieceType.None: return "N";
                default: return "P";
            }
        }
        ...
        internal static short CalculatePieceValue(ChessPieceType pieceType)
        {
            switch (pieceType)
            {
                ...
                case ChessPieceType.Bishop: return 325;
                case ChessPieceType.Rook: return 500;
                case ChessPieceType.Queen: return 975;
                case ChessPieceType.King: return 32767;
        ...
        internal static short CalculatePieceActionValue(ChessPieceType pieceType)
        {
            switch (pieceType)
            {
                case ChessPieceType.Pawn: return 6;
                case ChessPieceType.Knight: return 3;
                case ChessPieceType.Bishop: return 3;
                case ChessPieceType.Rook: return 2;
                case ChessPieceType.Queen: return 1;
                case ChessPieceType.King: return 1;
                case ChessPieceType.None: return 0;
                default: return 0;
            }
        }
